...
public class FocusActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FindUserListView=(ListView) findViewById(R.id.FocusListview);
    }
    ...
    protected void onResume() {
        ...
        new Thread() {
            @Override
            public void run() {
                String url = HttpUtilsHttpURLConnection.BASE_URL + "/FocusQuery";
                ...
                public void handleMessage(Message msg) {
                    if (msg.what == 0x11) {
                        ...
                        try {
                            ...
                            adapter = new UseritemAdapter(FocusActivity.this, userSearchResults);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        show.add(useritem);
        intent.setClass(FocusActivity.this, PersonalPageActivity.class);
